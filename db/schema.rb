...
ActiveRecord::Schema.define(version: 2021_10_29_062602) do
  ...
  create_table "join_private_message_recipients", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["private_message_id"], name: "index_join_private_message_recipients_on_private_message_id"
    t.index ["recipient_id"], name: "index_join_private_message_recipients_on_recipient_id"
  end
